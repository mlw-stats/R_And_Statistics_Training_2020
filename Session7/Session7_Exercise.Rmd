...
The exercise did not ask you to do is as part of the markdown document, but I wanted to include this here, so that you can fully reproduce my document.
...
if(!dir.exists("examplePack/data")){dir.create("examplePack/data",recursive=T)}

save(dat,file="examplePack/data/dat.rda")
