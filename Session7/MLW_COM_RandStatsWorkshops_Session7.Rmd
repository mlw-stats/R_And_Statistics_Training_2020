...
To create a new R pckage, make use of RStudio's project feature:
...
* If needed, create the files & directories from the previous slide either manually or using packages `devtools` (function `document()`) and `usethis` (when initiating a package). 
